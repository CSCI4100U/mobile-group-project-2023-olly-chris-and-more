...
class _StorePageState extends State<StorePage> {
  // Create defenders
  // Change this stuff to go with new pictures
  Defender cow = Defender(skin: Image.asset("assets/images/store_shroom.png", fit: BoxFit.contain),
                          locationX: 5, locationY: 5, health: 5, title: "Cow",
                          attack: Attack(damage: 5, rechargeTime: 5, distance: 5));
  Defender sheep = Defender(skin: Image.asset("assets/images/store_snail.png", fit: BoxFit.contain),
                            locationX: 5, locationY: 5, health: 5, title: "Sheep",
                            attack: Attack(damage: 5, rechargeTime: 5, distance: 5));
  Defender chicken = Defender(skin: Image.asset("assets/images/storechicken.png", fit: BoxFit.contain),
                              locationX: 5, locationY: 5, health: 5, title: "Chicken",
                              attack: Attack(damage: 5, rechargeTime: 5, distance: 5));
  Defender farmer = Defender(skin: Image.asset("assets/images/store_farmer.png", fit: BoxFit.contain),
                             locationX: 5, locationY: 5, health: 5, title: "Farmer",
                             attack: Attack(damage: 5, rechargeTime: 5, distance: 5));
  Defender cannon = Defender(skin: Image.asset("assets/images/store_radish.png", fit: BoxFit.contain),
