...
class Level extends World{
  ...
  FutureOr<void> onLoad() async {
    ...
    //add(Defender(idleGameImage: 'Enemies/Chicken/chicken_idle_(32x34).png'));
    // Wanna change this later to add all chosen defenders at once relating to game objects list
    //add(Defender(idleGameImage: 'Enemies/Mushroom/farmer_idle_(32x32).png'));
