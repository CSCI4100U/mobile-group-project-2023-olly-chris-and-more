...
class _StorePageState extends State<StorePage> {
  ...
  String? _enoughDefendersString = "Choose 3 defenders to protect the barn!";
  bool _upgradeChosen = false;
  String? _upgradeChosenString = "Choose an upgrade to help defend the barn!";
  ...
  Widget? _selectDefenderOrApplyUpgrade(BuildContext context, Object item){
                ...
                TextButton(
                    onPressed: (){
                      ...
                      if (_selectedDefenders.length == 3){
                        ...
                        _enoughDefendersString = "Max of 3 defenders chosen";
                      }
    ...
    if (item is Defender && _enoughDefenders == true){
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("You already chose your defenders!"),
