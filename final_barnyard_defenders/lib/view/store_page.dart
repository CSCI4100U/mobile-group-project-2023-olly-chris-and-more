...
class _StorePageState extends State<StorePage> {
  ...
  Defender shroom = Defender(
      storeImage: Image.asset("assets/images/Store/sshroom.png", fit: BoxFit.contain),
      idleGameImage: "Anim/shroom.png",
      title: "Shroom",
      health: 5,
  ...
  Defender snail = Defender(
      storeImage: Image.asset("assets/images/Store/ssnail.png", fit: BoxFit.contain),
      idleGameImage: "Anim/snail.png",
      title: "Snail",
      health: 5,
      attack: Attack(damage: 5, rechargeTime: 5, distance: 5),
      animationFrames: 15,
  ...
  Defender chicken = Defender(
      storeImage: Image.asset("assets/images/Store/schicken.png", fit: BoxFit.contain),
      idleGameImage: "Anim/chicken.png",
      title: "Chicken",
      health: 5,
      attack: Attack(damage: 5, rechargeTime: 5, distance: 5),
      animationFrames: 13,
  ...
  Defender farmer = Defender(
      storeImage: Image.asset("assets/images/Store/sfarmer.png", fit: BoxFit.contain),
      idleGameImage: "Anim/farmer.png",
      title: "Farmer",
      health: 5,
      attack: Attack(damage: 5, rechargeTime: 5, distance: 5),
      animationFrames: 11,
  ...
  Defender raddish = Defender(
      storeImage: Image.asset("assets/images/Store/sraddish.png", fit: BoxFit.contain),
      idleGameImage: "Anim/raddish.png",
      title: "Raddish",
      health: 5,
      attack: Attack(damage: 5, rechargeTime: 5, distance: 5),
      animationFrames: 6,
